...
@media (min-width: 1600px) {
  .rotate-category{
    transform: rotateZ(-90deg) translateX(-470px) translateY(-40px);
...
<section class="text-gray-600 body-font mb-8 mt-8">
        ...
        <!-- <div class="flex flex-no-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 justify-between"> -->
          ...
          {#each {length: 16} as slide, i}
            ...
            <card class="slide-content">
              <div class={`flex-shrink-0 m-4 relative overflow-hidden ${colors[i]} rounded-lg shadow-lg`}>
                ...
                <div class="relative text-white px-6 pb-6 -mt-6">
                  ...
                  <div class="flex justify-between">
                    ...
                    <span class="bg-white rounded-full text-black text-xs font-bold px-3 py-2 leading-none flex items-center">499 zł</span>
                  </div>
